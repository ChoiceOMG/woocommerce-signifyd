...
`wp-content/plugins/riskloom-fraud-screening-for-signifyd/` and activate it from the Plugins screen.
...
- Every translatable string uses the `riskloom-fraud-screening-for-signifyd` text domain, is a literal
...
```
phpcs --standard=WordPress-Extra includes/ riskloom-fraud-screening-for-signifyd.php
```
